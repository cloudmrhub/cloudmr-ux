...
export const getLoggedInToken = createAsyncThunk('SIGN_IN', async (signinData: SigninDataType, thunkAPI) => {
...
export const refreshAccessToken = createAsyncThunk('REFRESH_ACCESS_TOKEN',
