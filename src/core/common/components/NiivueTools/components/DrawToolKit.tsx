...
export const DrawToolkit = (props: DrawToolkitProps) => {
  ...
  const penColor = ["red", "green", "blue", "yellow", "cyan", "#e81ce8"][
    (props.drawPen & 7) - 1
  ];
      ...
      >
          ...
          <Stack direction="row">
            <IconButton aria-label="draw" onClick={clickPaintBrush}>
              <BrushIcon
                style={{
                  color:
                    expandedOption == "d" && penColor != undefined
                      ? penColor
                      : "white",
                }}
              />
        ...
        <FormControl>
          <IconButton
            ...
            onClick={() => {
              props.nv.saveScene(
                `${props.volumes[props.selectedVolume].name}_drawing.png`,
              );
            }}
          >
          ...
          <Stack direction="row">
            <IconButton aria-label="fill" onClick={clickMask}>
              <FormatColorFillIcon
                style={{
                  color:
                    expandedOption == "m" && maskColor != undefined
                      ? maskColor
                      : "white",
                }}
              />
    ...
    >
      <Stack sx={{ mb: 1 }} alignItems="center">
        <Typography
          ...
          fontSize={"11pt"}
          alignItems={"start"}
        >{`Opacity: ${drawingOpacity}`}</Typography>
        <Slider
          sx={{ width: "80%" }}
