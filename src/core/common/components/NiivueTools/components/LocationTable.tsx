    ...
    >
      <div className="row">
        ...
        <div className="col-auto">
          {props.label && <HintText>{props.label}:</HintText>}
        </div>

        <div className="col-auto">
          <HintText>{`Value: ${value ? value : undefined}`}</HintText>
        </div>
...
const HintText = (props: { children: React.ReactNode }) => {
  return (
    <span style={{ color: "white", fontSize: "inherit" }}>
      {props.children}
    </span>
  );
};
